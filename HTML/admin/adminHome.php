...
<body>
  ...
  <div class="content">
    ...
    <div id="home-admin" class="left-section">
      ...
      <h2>Prodotti</h2>
      <p>In questa sezione &egrave; possibile gestire i prodotti offerti dall'azienda. &Egrave; quindi
        possibile vedere le
      ...
      <h2>Servizi</h2>
      <p>In questa sezione &egrave; possibile gestire i servizi offerti dall'azienda. &Egrave; quindi
        possibile vedere le macchine disponibilili
        e modificarne il prezzo. Inoltre, &egrave; possibile eliminare una macchina esistente o inserirne una
        nuova.</p>
      <h2>Storico prenotazioni</h2>
      <p>In questa sezione &egrave; possibile visualizzare lo storico delle prenotazioni, ossia quelle
        prenotazioni che hanno come data di restituzione
      ...
      <p>In questa sezione &egrave; possibile visualizzare le prenotazioni attive, ossia quelle prenotazioni
        che sono in corso o hanno una data di inizio
        dopo quella odierna. &Egrave; quindi possibile eliminare una prenotazione ed inserirne una nuova:
        &egrave; necessario inserire prima il cliente se
        questo non &egrave; gi&agrave; nel database; quando poi si inseriranno i campi dati relativi alla
        prenotazione, il controllo della
      ...
      <p>In questa sezione &egrave; possibile visualizzare i clienti inseriti nel database. Un cliente, per
        ...
        salvato per prenotare un macchinario. &Egrave; quindi possibile modificare il numero di telefono e
        l'indirizzo <span xml:lang='en'>email</span>
        del cliente. Inoltre, &egrave; possibile inserirne uno nuovo o eliminarne uno esistente, solamente se
        questo non ha gi&agrave; effettuato una
      ...
      <p>In questa sezione &egrave; possibile visualizzare gli amministratori inseriti nel database. Nella
        lista non viene mostrato l'amministratore
        collegato all'account che ha eseguito l'accesso. &Egrave; quindi possibile eliminare un
        amministratore o inserne uno nuovo.</p>
    </div>
  </div>
  <?php
