  ...
  if (isset($_POST['submit'])) {
    ...
    if ($error == null) {
      ...
      if ($errorOk['error'] != null) {
        ...
        exit();
      } else if (!$connection->insertGrain($_POST['name'], $_POST['description'], $fileName, $_POST['price'], $_POST['availability'])) {
        $_SESSION['isError'] = true;
    ...
    if (isset($_POST['price']) && isset($_POST['grainName'])) {
      if ($_POST['price'] > 999.99) 
        $error = "Prezzo troppo alto, il massimo &egrave; di 999.99";
      else
