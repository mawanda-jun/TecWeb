      ...
      <div class="admin">
        ...
        if ($admins != null) {
          ...
          foreach ($admins as $admin)
            echo '<li>' . $admin['email'] . ' <a class="button" title="removing admin ' . $admin['email'] . '"' . ' href="adminManager.php?delete=' . $admin['email'] . '" >Elimina</a></li>';
          echo '</ul></div>';
        } else
        ...
        ?>
          ...
          <form id="insertAdmin" action="adminManager.php" method="post">
            ...
            <fieldset id="adminFields">
              ...
              <div id="errorInput">
                <?php if ($_SESSION['isError']) echo $_SESSION['error'] ?>
              </div>
