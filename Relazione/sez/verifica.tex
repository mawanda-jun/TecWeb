...
\begin{itemize}
	...
	\item Asus Zenfone 2;
\end{itemize}
utilizzando differenti browser mobile. L'usabilità della parte di utenza generica rimane invariata, in quanto responsive. La parte amministrativa è stata pensata per poter essere utilizzata in un ambiante desktop, tuttavia è stata pensata anche per poter essere utilizzata in casi eccezzionali con dispositivi mobile.